...
class SATSSObbAssigner(BaseAssigner):
    ...
    def assign(self,
        ...
        # mean and std, set mean + std as the iou threshold
        gt_bboxes_source = gt_bboxes.detach()
        ...
        gt_bboxes_ratios = self.AspectRatio(gt_bboxes_source)
        iou_thr_weight = 1 - 2 / torch.pi * torch.arctan(gt_bboxes_ratios / 16)
